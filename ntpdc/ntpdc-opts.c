 ...
 *
 *  It has been AutoGen-ed  January  2, 2015 at 11:05:46 PM by AutoGen 5.18.5pre4
...
/*  1657 */ "no\0"
/*  1660 */ "NTPDC\0"
/*  1666 */ "ntpdc - vendor-specific NTPD control program - Ver. 4.2.8p1-beta3\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntpdc - vendor-specific NTPD control program - Ver. 4.2.8p1-beta3\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
