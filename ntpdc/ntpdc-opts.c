 ...
 *
 *  It has been AutoGen-ed  March 30, 2015 at 04:46:30 AM by AutoGen 5.18.5pre4
...
/*  1711 */ "no\0"
/*  1714 */ "NTPDC\0"
/*  1720 */ "ntpdc - vendor-specific NTPD control program - Ver. 4.2.8p2-RC1\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpdc - vendor-specific NTPD control program - Ver. 4.2.8p2-RC1\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
