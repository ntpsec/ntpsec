 ...
 *
 *  It has been AutoGen-ed  April  1, 2014 at 10:44:28 AM by AutoGen 5.18.3pre18
...
/*  1653 */ "no\0"
/*  1656 */ "NTPDC\0"
/*  1662 */ "ntpdc - vendor-specific NTPD control program - Ver. 4.2.7p438\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntpdc - vendor-specific NTPD control program - Ver. 4.2.7p438\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
