 ...
 *
 *  It has been AutoGen-ed  March  4, 2015 at 11:57:16 AM by AutoGen 5.18.5pre4
...
/*  1705 */ "no\0"
/*  1708 */ "NTPDC\0"
/*  1714 */ "ntpdc - vendor-specific NTPD control program - Ver. 4.3.4\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpdc - vendor-specific NTPD control program - Ver. 4.3.4\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
