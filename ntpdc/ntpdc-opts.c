 ...
 *
 *  It has been AutoGen-ed  December 18, 2014 at 09:39:13 AM by AutoGen 5.18.5pre4
...
/*  1656 */ "no\0"
/*  1659 */ "NTPDC\0"
/*  1665 */ "ntpdc - vendor-specific NTPD control program - Ver. 4.2.7p486-RC\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntpdc - vendor-specific NTPD control program - Ver. 4.2.7p486-RC\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
