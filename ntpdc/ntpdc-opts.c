 ...
 *
 *  It has been AutoGen-ed  December 12, 2014 at 11:56:24 AM by AutoGen 5.18.5pre4
...
/*  1656 */ "no\0"
/*  1659 */ "NTPDC\0"
/*  1665 */ "ntpdc - vendor-specific NTPD control program - Ver. 4.2.7p485-RC\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntpdc - vendor-specific NTPD control program - Ver. 4.2.7p485-RC\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
