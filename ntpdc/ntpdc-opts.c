 ...
 *
 *  It has been AutoGen-ed  July 18, 2014 at 09:31:05 AM by AutoGen 5.18.3pre18
...
/*  1653 */ "no\0"
/*  1656 */ "NTPDC\0"
/*  1662 */ "ntpdc - vendor-specific NTPD control program - Ver. 4.2.7p452\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntpdc - vendor-specific NTPD control program - Ver. 4.2.7p452\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
