 ...
 *
 *  It has been AutoGen-ed  July  5, 2013 at 11:36:45 AM by AutoGen 5.17.3
...
/*  1653 */ "no\0"
/*  1656 */ "NTPDC\0"
/*  1662 */ "ntpdc - vendor-specific NTPD control program - Ver. 4.2.7p369\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntpdc - vendor-specific NTPD control program - Ver. 4.2.7p369\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
