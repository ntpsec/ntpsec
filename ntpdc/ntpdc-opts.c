 ...
 *
 *  It has been AutoGen-ed  June  4, 2015 at 03:36:25 AM by AutoGen 5.18.5
...
/*  1706 */ "no\0"
/*  1709 */ "NTPDC\0"
/*  1715 */ "ntpdc - vendor-specific NTPD control program - Ver. 4.3.34\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpdc - vendor-specific NTPD control program - Ver. 4.3.34\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
