 ...
 *
 *  It has been AutoGen-ed  November 21, 2014 at 08:57:32 AM by AutoGen 5.18.5pre4
...
/*  1653 */ "no\0"
/*  1656 */ "NTPDC\0"
/*  1662 */ "ntpdc - vendor-specific NTPD control program - Ver. 4.2.7p480\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntpdc - vendor-specific NTPD control program - Ver. 4.2.7p480\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
