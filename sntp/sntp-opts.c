 ...
 *
 *  It has been AutoGen-ed  February  8, 2014 at 11:07:43 AM by AutoGen 5.18.3pre11
...
/*  2254 */ "no-load-opts\0"
/*  2267 */ "SNTP\0"
/*  2272 */ "sntp - standard Simple Network Time Protocol client program - Ver. 4.2.7p419\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("sntp - standard Simple Network Time Protocol client program - Ver. 4.2.7p419\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ hostname-or-IP ...]\n"));
