...
#define zLicenseDescrip (sntp_opt_strs+346)
 ...
 */
static char const sntp_opt_strs[1913] =
/*     0 */ "sntp 4.2.8p1-beta2\n"
            "Copyright (C) 1992-2015 The University of Delaware and Network Time Foundation, all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the NTP License, copies of which\n"
            "can be seen at:\n"
...
/*   432 */ "IPV6\0"
/*   437 */ "ipv6\0"
/*   442 */ "Enable authentication with the key auth-keynumber\0"
/*   492 */ "AUTHENTICATION\0"
/*   507 */ "authentication\0"
/*   522 */ "Listen to the address specified for broadcast time sync\0"
/*   578 */ "BROADCAST\0"
/*   588 */ "broadcast\0"
/*   598 */ "Concurrently query all IPs returned for host-name\0"
/*   648 */ "CONCURRENT\0"
/*   659 */ "concurrent\0"
/*   670 */ "Increase debug verbosity level\0"
/*   701 */ "DEBUG_LEVEL\0"
/*   713 */ "debug-level\0"
/*   725 */ "Set the debug verbosity level\0"
/*   755 */ "SET_DEBUG_LEVEL\0"
/*   771 */ "set-debug-level\0"
/*   787 */ "The gap (in milliseconds) between time requests\0"
/*   835 */ "GAP\0"
/*   839 */ "gap\0"
/*   843 */ "KoD history filename\0"
/*   864 */ "KOD\0"
/*   868 */ "kod\0"
/*   872 */ "/var/db/ntp-kod\0"
/*   888 */ "Look in this file for the key specified with -a\0"
/*   936 */ "KEYFILE\0"
/*   944 */ "keyfile\0"
/*   952 */ "Log to specified logfile\0"
/*   977 */ "LOGFILE\0"
/*   985 */ "logfile\0"
/*   993 */ "Adjustments less than steplimit msec will be slewed\0"
/*  1045 */ "STEPLIMIT\0"
/*  1055 */ "steplimit\0"
/*  1065 */ "Send int as our NTP protocol version\0"
/*  1102 */ "NTPVERSION\0"
/*  1113 */ "ntpversion\0"
/*  1124 */ "Use the NTP Reserved Port (port 123)\0"
/*  1161 */ "USERESERVEDPORT\0"
/*  1177 */ "usereservedport\0"
/*  1193 */ "OK to 'step' the time with settimeofday(2)\0"
/*  1236 */ "STEP\0"
/*  1241 */ "step\0"
/*  1246 */ "OK to 'slew' the time with adjtime(2)\0"
/*  1284 */ "SLEW\0"
/*  1289 */ "slew\0"
/*  1294 */ "The number of seconds to wait for responses\0"
/*  1338 */ "TIMEOUT\0"
/*  1346 */ "timeout\0"
/*  1354 */ "Wait for pending replies (if not setting the time)\0"
/*  1405 */ "WAIT\0"
/*  1410 */ "no-wait\0"
/*  1418 */ "no\0"
/*  1421 */ "display extended usage information and exit\0"
/*  1465 */ "help\0"
/*  1470 */ "extended usage information passed thru pager\0"
/*  1515 */ "more-help\0"
/*  1525 */ "output version information and exit\0"
/*  1561 */ "version\0"
/*  1569 */ "save the option state to a config file\0"
/*  1608 */ "save-opts\0"
/*  1618 */ "load options from a config file\0"
/*  1650 */ "LOAD_OPTS\0"
/*  1660 */ "no-load-opts\0"
/*  1673 */ "SNTP\0"
/*  1678 */ "sntp - standard Simple Network Time Protocol client program - Ver. 4.2.8p1-beta2\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n"
            "\t\t[ hostname-or-IP ...]\n\0"
/*  1843 */ "$HOME\0"
/*  1849 */ ".\0"
/*  1851 */ ".ntprc\0"
/*  1858 */ "http://bugs.ntp.org, bugs@ntp.org\0"
/*  1892 */ "\n\0"
/*  1894 */ "sntp 4.2.8p1-beta2";
...
#define IPV4_DESC      (sntp_opt_strs+360)
/** Upper-cased name for the ipv4 option */
#define IPV4_NAME      (sntp_opt_strs+391)
/** Name string for the ipv4 option */
#define IPV4_name      (sntp_opt_strs+396)
...
#define IPV6_DESC      (sntp_opt_strs+401)
/** Upper-cased name for the ipv6 option */
#define IPV6_NAME      (sntp_opt_strs+432)
/** Name string for the ipv6 option */
#define IPV6_name      (sntp_opt_strs+437)
...
#define AUTHENTICATION_DESC      (sntp_opt_strs+442)
/** Upper-cased name for the authentication option */
#define AUTHENTICATION_NAME      (sntp_opt_strs+492)
/** Name string for the authentication option */
#define AUTHENTICATION_name      (sntp_opt_strs+507)
...
#define BROADCAST_DESC      (sntp_opt_strs+522)
/** Upper-cased name for the broadcast option */
#define BROADCAST_NAME      (sntp_opt_strs+578)
/** Name string for the broadcast option */
#define BROADCAST_name      (sntp_opt_strs+588)
...
#define CONCURRENT_DESC      (sntp_opt_strs+598)
/** Upper-cased name for the concurrent option */
#define CONCURRENT_NAME      (sntp_opt_strs+648)
/** Name string for the concurrent option */
#define CONCURRENT_name      (sntp_opt_strs+659)
...
#define DEBUG_LEVEL_DESC      (sntp_opt_strs+670)
/** Upper-cased name for the debug-level option */
#define DEBUG_LEVEL_NAME      (sntp_opt_strs+701)
/** Name string for the debug-level option */
#define DEBUG_LEVEL_name      (sntp_opt_strs+713)
...
#define SET_DEBUG_LEVEL_DESC      (sntp_opt_strs+725)
/** Upper-cased name for the set-debug-level option */
#define SET_DEBUG_LEVEL_NAME      (sntp_opt_strs+755)
/** Name string for the set-debug-level option */
#define SET_DEBUG_LEVEL_name      (sntp_opt_strs+771)
...
#define GAP_DESC      (sntp_opt_strs+787)
/** Upper-cased name for the gap option */
#define GAP_NAME      (sntp_opt_strs+835)
/** Name string for the gap option */
#define GAP_name      (sntp_opt_strs+839)
...
#define KOD_DESC      (sntp_opt_strs+843)
/** Upper-cased name for the kod option */
#define KOD_NAME      (sntp_opt_strs+864)
/** Name string for the kod option */
#define KOD_name      (sntp_opt_strs+868)
/** The compiled in default value for the kod option argument */
#define KOD_DFT_ARG   (sntp_opt_strs+872)
...
#define KEYFILE_DESC      (sntp_opt_strs+888)
/** Upper-cased name for the keyfile option */
#define KEYFILE_NAME      (sntp_opt_strs+936)
/** Name string for the keyfile option */
#define KEYFILE_name      (sntp_opt_strs+944)
...
#define LOGFILE_DESC      (sntp_opt_strs+952)
/** Upper-cased name for the logfile option */
#define LOGFILE_NAME      (sntp_opt_strs+977)
/** Name string for the logfile option */
#define LOGFILE_name      (sntp_opt_strs+985)
...
#define STEPLIMIT_DESC      (sntp_opt_strs+993)
/** Upper-cased name for the steplimit option */
#define STEPLIMIT_NAME      (sntp_opt_strs+1045)
/** Name string for the steplimit option */
#define STEPLIMIT_name      (sntp_opt_strs+1055)
...
#define NTPVERSION_DESC      (sntp_opt_strs+1065)
/** Upper-cased name for the ntpversion option */
#define NTPVERSION_NAME      (sntp_opt_strs+1102)
/** Name string for the ntpversion option */
#define NTPVERSION_name      (sntp_opt_strs+1113)
...
#define USERESERVEDPORT_DESC      (sntp_opt_strs+1124)
/** Upper-cased name for the usereservedport option */
#define USERESERVEDPORT_NAME      (sntp_opt_strs+1161)
/** Name string for the usereservedport option */
#define USERESERVEDPORT_name      (sntp_opt_strs+1177)
...
#define STEP_DESC      (sntp_opt_strs+1193)
/** Upper-cased name for the step option */
#define STEP_NAME      (sntp_opt_strs+1236)
/** Name string for the step option */
#define STEP_name      (sntp_opt_strs+1241)
...
#define SLEW_DESC      (sntp_opt_strs+1246)
/** Upper-cased name for the slew option */
#define SLEW_NAME      (sntp_opt_strs+1284)
/** Name string for the slew option */
#define SLEW_name      (sntp_opt_strs+1289)
...
#define TIMEOUT_DESC      (sntp_opt_strs+1294)
/** Upper-cased name for the timeout option */
#define TIMEOUT_NAME      (sntp_opt_strs+1338)
/** Name string for the timeout option */
#define TIMEOUT_name      (sntp_opt_strs+1346)
...
#define WAIT_DESC      (sntp_opt_strs+1354)
/** Upper-cased name for the wait option */
#define WAIT_NAME      (sntp_opt_strs+1405)
/** disablement name for the wait option */
#define NOT_WAIT_name  (sntp_opt_strs+1410)
/** disablement prefix for the wait option */
#define NOT_WAIT_PFX   (sntp_opt_strs+1418)
 ...
 */
#define HELP_DESC       (sntp_opt_strs+1421)
#define HELP_name       (sntp_opt_strs+1465)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (sntp_opt_strs+1470)
#define MORE_HELP_name  (sntp_opt_strs+1515)
...
#endif
#define VER_DESC        (sntp_opt_strs+1525)
#define VER_name        (sntp_opt_strs+1561)
#define SAVE_OPTS_DESC  (sntp_opt_strs+1569)
#define SAVE_OPTS_name  (sntp_opt_strs+1608)
#define LOAD_OPTS_DESC     (sntp_opt_strs+1618)
#define LOAD_OPTS_NAME     (sntp_opt_strs+1650)
#define NO_LOAD_OPTS_name  (sntp_opt_strs+1660)
#define LOAD_OPTS_pfx      (sntp_opt_strs+1418)
...
#define zPROGNAME       (sntp_opt_strs+1673)
/** Reference to the title line for sntp usage. */
#define zUsageTitle     (sntp_opt_strs+1678)
/** sntp configuration file name. */
#define zRcName         (sntp_opt_strs+1851)
...
can be seen at:\n"));
  ...
  puts(_("sntp - standard Simple Network Time Protocol client program - Ver. 4.2.8p1-beta2\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ hostname-or-IP ...]\n"));
