 ...
 *
 *  It has been AutoGen-ed  April  3, 2015 at 03:46:06 AM by AutoGen 5.18.5pre4
...
/*  2312 */ "no-load-opts\0"
/*  2325 */ "SNTP\0"
/*  2330 */ "sntp - standard Simple Network Time Protocol client program - Ver. 4.2.8p2-RC3\n"
...
implied warranty.\n"));
  ...
  puts(_("sntp - standard Simple Network Time Protocol client program - Ver. 4.2.8p2-RC3\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ hostname-or-IP ...]\n"));
