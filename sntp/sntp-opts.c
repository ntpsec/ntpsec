 ...
 *
 *  It has been AutoGen-ed  February 22, 2014 at 10:37:15 AM by AutoGen 5.18.3pre11
...
/*  2254 */ "no-load-opts\0"
/*  2267 */ "SNTP\0"
/*  2272 */ "sntp - standard Simple Network Time Protocol client program - Ver. 4.2.7p423\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("sntp - standard Simple Network Time Protocol client program - Ver. 4.2.7p423\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ hostname-or-IP ...]\n"));
