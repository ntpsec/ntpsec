 ...
 *
 *  It has been AutoGen-ed  March  6, 2015 at 11:48:44 AM by AutoGen 5.18.5pre4
...
/*  2306 */ "no-load-opts\0"
/*  2319 */ "SNTP\0"
/*  2324 */ "sntp - standard Simple Network Time Protocol client program - Ver. 4.3.6\n"
...
implied warranty.\n"));
  ...
  puts(_("sntp - standard Simple Network Time Protocol client program - Ver. 4.3.6\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ hostname-or-IP ...]\n"));
