...
/*  2254 */ "no-load-opts\0"
/*  2267 */ "SNTP\0"
/*  2272 */ "sntp - standard Simple Network Time Protocol client program - Ver. 4.2.7p384\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("sntp - standard Simple Network Time Protocol client program - Ver. 4.2.7p384\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ hostname-or-IP ...]\n"));
