 ...
 *
 *  It has been AutoGen-ed  July  5, 2013 at 11:26:14 AM by AutoGen 5.17.3
...
/*  2254 */ "no-load-opts\0"
/*  2267 */ "SNTP\0"
/*  2272 */ "sntp - standard Simple Network Time Protocol client program - Ver. 4.2.7p369\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("sntp - standard Simple Network Time Protocol client program - Ver. 4.2.7p369\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ hostname-or-IP ...]\n"));
