...
#define	STEREO	(1)
	...
	while ((temp = getopt(argc, argv, "a:b:c:df:g:hHi:jk:l:o:q:r:xy:z?")) != -1) {
#else
	while ((temp = getopt(argc, argv, "a:b:c:df:g:hHi:jk:l:o:q:r:v:xy:z?")) != -1) {
#endif
		switch (temp) {
