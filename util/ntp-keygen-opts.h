 ...
 *  
 *  It has been AutoGen-ed  October  2, 2010 at 08:00:47 AM by AutoGen 5.10
...
#define OPTION_CT    23
#define NTP_KEYGEN_VERSION       "4.2.7p59"
#define NTP_KEYGEN_FULL_VERSION  "ntp-keygen (ntp) - Create a NTP host key - Ver. 4.2.7p59"
