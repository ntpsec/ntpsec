 ...
 *  
 *  It has been AutoGen-ed  Sunday August  5, 2007 at 07:43:12 AM EDT
...
#define OPTION_CT    24
#define NTP_KEYGEN_VERSION       "4.2.5p65"
#define NTP_KEYGEN_FULL_VERSION  "ntp-keygen (ntp) - Create a NTP host key - Ver. 4.2.5p65"
