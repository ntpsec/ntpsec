 ...
 *  
 *  It has been AutoGen-ed  Thursday October 18, 2007 at 07:48:19 AM EDT
...
#define OPTION_CT    24
#define NTP_KEYGEN_VERSION       "4.2.5p84"
#define NTP_KEYGEN_FULL_VERSION  "ntp-keygen (ntp) - Create a NTP host key - Ver. 4.2.5p84"
