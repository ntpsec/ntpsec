 ...
 *  
 *  It has been AutoGen-ed  Tuesday June  5, 2007 at 07:44:26 AM EDT
...
#define OPTION_CT    24
#define NTP_KEYGEN_VERSION       "4.2.5p45"
#define NTP_KEYGEN_FULL_VERSION  "ntp-keygen (ntp) - Create a NTP host key - Ver. 4.2.5p45"
