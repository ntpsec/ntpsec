 ...
 *
 *  It has been AutoGen-ed  March 10, 2015 at 12:35:50 PM by AutoGen 5.18.5pre4
...
/*  2213 */ "no\0"
/*  2216 */ "NTP_KEYGEN\0"
/*  2227 */ "ntp-keygen (ntp) - Create a NTP host key - Ver. 4.3.8\n"
...
implied warranty.\n"));
  ...
  puts(_("ntp-keygen (ntp) - Create a NTP host key - Ver. 4.3.8\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
