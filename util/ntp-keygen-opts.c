 ...
 *
 *  It has been AutoGen-ed  November 29, 2013 at 11:33:05 AM by AutoGen 5.18.3pre5
...
/*  2149 */ "no\0"
/*  2152 */ "NTP_KEYGEN\0"
/*  2163 */ "ntp-keygen (ntp) - Create a NTP host key - Ver. 4.2.7p400\n"
...
static void bogus_function(void) {
  ...
  puts(_("ntp-keygen (ntp) 4.2.7p400\n\
Copyright (C) 1970-2013 The University of Delaware, all rights reserved.\n\
This is free software. It is licensed for use, modification and\n\
redistribution under the terms of the NTP License, copies of which\n\
can be seen at:\n"));
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntp-keygen (ntp) - Create a NTP host key - Ver. 4.2.7p400\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
