 ...
 *
 *  It has been AutoGen-ed  March  5, 2015 at 11:58:29 AM by AutoGen 5.18.5pre4
...
/*  2213 */ "no\0"
/*  2216 */ "NTP_KEYGEN\0"
/*  2227 */ "ntp-keygen (ntp) - Create a NTP host key - Ver. 4.3.5\n"
...
implied warranty.\n"));
  ...
  puts(_("ntp-keygen (ntp) - Create a NTP host key - Ver. 4.3.5\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
