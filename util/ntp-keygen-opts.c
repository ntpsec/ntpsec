 ...
 *
 *  It has been AutoGen-ed  March 29, 2015 at 07:13:10 AM by AutoGen 5.18.5pre4
...
/*  2214 */ "no\0"
/*  2217 */ "NTP_KEYGEN\0"
/*  2228 */ "ntp-keygen (ntp) - Create a NTP host key - Ver. 4.3.11\n"
...
implied warranty.\n"));
  ...
  puts(_("ntp-keygen (ntp) - Create a NTP host key - Ver. 4.3.11\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
