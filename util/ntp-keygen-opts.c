 ...
 *
 *  It has been AutoGen-ed  January 14, 2015 at 10:49:38 AM by AutoGen 5.18.5pre6
...
#define zLicenseDescrip (ntp_keygen_opt_strs+358)
 ...
 */
static char const ntp_keygen_opt_strs[1783] =
/*     0 */ "ntp-keygen (ntp) 4.2.8p1-beta2\n"
            "Copyright (C) 1992-2015 The University of Delaware and Network Time Foundation, all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the NTP License, copies of which\n"
            "can be seen at:\n"
            ...
            "  <http://opensource.org/licenses/ntp-license.php>\n\0"
/*   358 */ "GRONK: OWNER\n\0"
/*   372 */ "identity modulus bits\0"
/*   394 */ "IMBITS\0"
/*   401 */ "imbits\0"
/*   408 */ "certificate scheme\0"
/*   427 */ "CERTIFICATE\0"
/*   439 */ "certificate\0"
/*   451 */ "privatekey cipher\0"
/*   469 */ "CIPHER\0"
/*   476 */ "cipher\0"
/*   483 */ "Increase debug verbosity level\0"
/*   514 */ "DEBUG_LEVEL\0"
/*   526 */ "debug-level\0"
/*   538 */ "Set the debug verbosity level\0"
/*   568 */ "SET_DEBUG_LEVEL\0"
/*   584 */ "set-debug-level\0"
/*   600 */ "Write IFF or GQ identity keys\0"
/*   630 */ "ID_KEY\0"
/*   637 */ "id-key\0"
/*   644 */ "Generate GQ parameters and keys\0"
/*   676 */ "GQ_PARAMS\0"
/*   686 */ "gq-params\0"
/*   696 */ "generate RSA host key\0"
/*   718 */ "HOST_KEY\0"
/*   727 */ "host-key\0"
/*   736 */ "generate IFF parameters\0"
/*   760 */ "IFFKEY\0"
/*   767 */ "iffkey\0"
/*   774 */ "set Autokey group name\0"
/*   797 */ "IDENT\0"
/*   803 */ "ident\0"
/*   809 */ "set certificate lifetime\0"
/*   834 */ "LIFETIME\0"
/*   843 */ "lifetime\0"
/*   852 */ "generate MD5 keys\0"
/*   870 */ "MD5KEY\0"
/*   877 */ "md5key\0"
/*   884 */ "modulus\0"
/*   892 */ "MODULUS\0"
/*   900 */ "generate PC private certificate\0"
/*   932 */ "PVT_CERT\0"
/*   941 */ "pvt-cert\0"
/*   950 */ "local private password\0"
/*   973 */ "PASSWORD\0"
/*   982 */ "password\0"
/*   991 */ "export IFF or GQ group keys with password\0"
/*  1033 */ "EXPORT_PASSWD\0"
/*  1047 */ "export-passwd\0"
/*  1061 */ "generate sign key (RSA or DSA)\0"
/*  1092 */ "SIGN_KEY\0"
/*  1101 */ "sign-key\0"
/*  1110 */ "set host and optionally group name\0"
/*  1145 */ "SUBJECT_NAME\0"
/*  1158 */ "subject-name\0"
/*  1171 */ "trusted certificate (TC scheme)\0"
/*  1203 */ "TRUSTED_CERT\0"
/*  1216 */ "trusted-cert\0"
/*  1229 */ "generate <num> MV parameters\0"
/*  1258 */ "MV_PARAMS\0"
/*  1268 */ "mv-params\0"
/*  1278 */ "update <num> MV keys\0"
/*  1299 */ "MV_KEYS\0"
/*  1307 */ "mv-keys\0"
/*  1315 */ "display extended usage information and exit\0"
/*  1359 */ "help\0"
/*  1364 */ "extended usage information passed thru pager\0"
/*  1409 */ "more-help\0"
/*  1419 */ "output version information and exit\0"
/*  1455 */ "version\0"
/*  1463 */ "save the option state to a config file\0"
/*  1502 */ "save-opts\0"
/*  1512 */ "load options from a config file\0"
/*  1544 */ "LOAD_OPTS\0"
/*  1554 */ "no-load-opts\0"
/*  1567 */ "no\0"
/*  1570 */ "NTP_KEYGEN\0"
/*  1581 */ "ntp-keygen (ntp) - Create a NTP host key - Ver. 4.2.8p1-beta2\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n\0"
/*  1701 */ "$HOME\0"
/*  1707 */ ".\0"
/*  1709 */ ".ntprc\0"
/*  1716 */ "http://bugs.ntp.org, bugs@ntp.org\0"
/*  1750 */ "\n\0"
/*  1752 */ "ntp-keygen (ntp) 4.2.8p1-beta2";
...
#define IMBITS_DESC      (ntp_keygen_opt_strs+372)
/** Upper-cased name for the imbits option */
#define IMBITS_NAME      (ntp_keygen_opt_strs+394)
/** Name string for the imbits option */
#define IMBITS_name      (ntp_keygen_opt_strs+401)
...
#define CERTIFICATE_DESC      (ntp_keygen_opt_strs+408)
/** Upper-cased name for the certificate option */
#define CERTIFICATE_NAME      (ntp_keygen_opt_strs+427)
/** Name string for the certificate option */
#define CERTIFICATE_name      (ntp_keygen_opt_strs+439)
...
#define CIPHER_DESC      (ntp_keygen_opt_strs+451)
/** Upper-cased name for the cipher option */
#define CIPHER_NAME      (ntp_keygen_opt_strs+469)
/** Name string for the cipher option */
#define CIPHER_name      (ntp_keygen_opt_strs+476)
...
#define DEBUG_LEVEL_DESC      (ntp_keygen_opt_strs+483)
/** Upper-cased name for the debug-level option */
#define DEBUG_LEVEL_NAME      (ntp_keygen_opt_strs+514)
/** Name string for the debug-level option */
#define DEBUG_LEVEL_name      (ntp_keygen_opt_strs+526)
...
#define SET_DEBUG_LEVEL_DESC      (ntp_keygen_opt_strs+538)
/** Upper-cased name for the set-debug-level option */
#define SET_DEBUG_LEVEL_NAME      (ntp_keygen_opt_strs+568)
/** Name string for the set-debug-level option */
#define SET_DEBUG_LEVEL_name      (ntp_keygen_opt_strs+584)
...
#define ID_KEY_DESC      (ntp_keygen_opt_strs+600)
/** Upper-cased name for the id-key option */
#define ID_KEY_NAME      (ntp_keygen_opt_strs+630)
/** Name string for the id-key option */
#define ID_KEY_name      (ntp_keygen_opt_strs+637)
...
#define GQ_PARAMS_DESC      (ntp_keygen_opt_strs+644)
/** Upper-cased name for the gq-params option */
#define GQ_PARAMS_NAME      (ntp_keygen_opt_strs+676)
/** Name string for the gq-params option */
#define GQ_PARAMS_name      (ntp_keygen_opt_strs+686)
...
#define HOST_KEY_DESC      (ntp_keygen_opt_strs+696)
/** Upper-cased name for the host-key option */
#define HOST_KEY_NAME      (ntp_keygen_opt_strs+718)
/** Name string for the host-key option */
#define HOST_KEY_name      (ntp_keygen_opt_strs+727)
...
#define IFFKEY_DESC      (ntp_keygen_opt_strs+736)
/** Upper-cased name for the iffkey option */
#define IFFKEY_NAME      (ntp_keygen_opt_strs+760)
/** Name string for the iffkey option */
#define IFFKEY_name      (ntp_keygen_opt_strs+767)
...
#define IDENT_DESC      (ntp_keygen_opt_strs+774)
/** Upper-cased name for the ident option */
#define IDENT_NAME      (ntp_keygen_opt_strs+797)
/** Name string for the ident option */
#define IDENT_name      (ntp_keygen_opt_strs+803)
...
#define LIFETIME_DESC      (ntp_keygen_opt_strs+809)
/** Upper-cased name for the lifetime option */
#define LIFETIME_NAME      (ntp_keygen_opt_strs+834)
/** Name string for the lifetime option */
#define LIFETIME_name      (ntp_keygen_opt_strs+843)
...
#define MD5KEY_DESC      (ntp_keygen_opt_strs+852)
/** Upper-cased name for the md5key option */
#define MD5KEY_NAME      (ntp_keygen_opt_strs+870)
/** Name string for the md5key option */
#define MD5KEY_name      (ntp_keygen_opt_strs+877)
...
#define MODULUS_DESC      (ntp_keygen_opt_strs+884)
/** Upper-cased name for the modulus option */
#define MODULUS_NAME      (ntp_keygen_opt_strs+892)
/** Name string for the modulus option */
#define MODULUS_name      (ntp_keygen_opt_strs+884)
...
#define PVT_CERT_DESC      (ntp_keygen_opt_strs+900)
/** Upper-cased name for the pvt-cert option */
#define PVT_CERT_NAME      (ntp_keygen_opt_strs+932)
/** Name string for the pvt-cert option */
#define PVT_CERT_name      (ntp_keygen_opt_strs+941)
...
#define PASSWORD_DESC      (ntp_keygen_opt_strs+950)
/** Upper-cased name for the password option */
#define PASSWORD_NAME      (ntp_keygen_opt_strs+973)
/** Name string for the password option */
#define PASSWORD_name      (ntp_keygen_opt_strs+982)
...
#define EXPORT_PASSWD_DESC      (ntp_keygen_opt_strs+991)
/** Upper-cased name for the export-passwd option */
#define EXPORT_PASSWD_NAME      (ntp_keygen_opt_strs+1033)
/** Name string for the export-passwd option */
#define EXPORT_PASSWD_name      (ntp_keygen_opt_strs+1047)
...
#define SIGN_KEY_DESC      (ntp_keygen_opt_strs+1061)
/** Upper-cased name for the sign-key option */
#define SIGN_KEY_NAME      (ntp_keygen_opt_strs+1092)
/** Name string for the sign-key option */
#define SIGN_KEY_name      (ntp_keygen_opt_strs+1101)
...
#define SUBJECT_NAME_DESC      (ntp_keygen_opt_strs+1110)
/** Upper-cased name for the subject-name option */
#define SUBJECT_NAME_NAME      (ntp_keygen_opt_strs+1145)
/** Name string for the subject-name option */
#define SUBJECT_NAME_name      (ntp_keygen_opt_strs+1158)
...
#define TRUSTED_CERT_DESC      (ntp_keygen_opt_strs+1171)
/** Upper-cased name for the trusted-cert option */
#define TRUSTED_CERT_NAME      (ntp_keygen_opt_strs+1203)
/** Name string for the trusted-cert option */
#define TRUSTED_CERT_name      (ntp_keygen_opt_strs+1216)
...
#define MV_PARAMS_DESC      (ntp_keygen_opt_strs+1229)
/** Upper-cased name for the mv-params option */
#define MV_PARAMS_NAME      (ntp_keygen_opt_strs+1258)
/** Name string for the mv-params option */
#define MV_PARAMS_name      (ntp_keygen_opt_strs+1268)
...
#define MV_KEYS_DESC      (ntp_keygen_opt_strs+1278)
/** Upper-cased name for the mv-keys option */
#define MV_KEYS_NAME      (ntp_keygen_opt_strs+1299)
/** Name string for the mv-keys option */
#define MV_KEYS_name      (ntp_keygen_opt_strs+1307)
 ...
 */
#define HELP_DESC       (ntp_keygen_opt_strs+1315)
#define HELP_name       (ntp_keygen_opt_strs+1359)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (ntp_keygen_opt_strs+1364)
#define MORE_HELP_name  (ntp_keygen_opt_strs+1409)
...
#endif
#define VER_DESC        (ntp_keygen_opt_strs+1419)
#define VER_name        (ntp_keygen_opt_strs+1455)
#define SAVE_OPTS_DESC  (ntp_keygen_opt_strs+1463)
#define SAVE_OPTS_name  (ntp_keygen_opt_strs+1502)
#define LOAD_OPTS_DESC     (ntp_keygen_opt_strs+1512)
#define LOAD_OPTS_NAME     (ntp_keygen_opt_strs+1544)
#define NO_LOAD_OPTS_name  (ntp_keygen_opt_strs+1554)
#define LOAD_OPTS_pfx      (ntp_keygen_opt_strs+1567)
...
static void bogus_function(void) {
  ...
  puts(_("ntp-keygen (ntp) 4.2.8p1-beta2\n\
Copyright (C) 1992-2015 The University of Delaware and Network Time Foundation, all rights reserved.\n\
This is free software. It is licensed for use, modification and\n\
redistribution under the terms of the NTP License, copies of which\n\
can be seen at:\n"));
  ...
  puts(_("ntp-keygen (ntp) - Create a NTP host key - Ver. 4.2.8p1-beta2\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
