 ...
 *
 * This table is nn longer used by ntpd. Many of these types no longer
 * exist in NTPSec.  They're still listed here so ntpq will still be
 * able to mine data from legacy versions. 
 */
#include <config.h>
#include <stdio.h>
