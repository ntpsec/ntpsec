...
[address] is an ASCII-encoded [ANSI.X3-4.1986] string conforming to the
syntax of the Host subcomponent of a URI ([RFC3986]). *address* may be a
hostname, a FQDN, an IPv4 numeric address, an IPv6 numeric addresa (in
square brackets).  Address may have the suffix *:port* to specify a UDP
port.
