...
before it was published. As a result, while ntpsec-versions before 1.2.0
...
1.2.0 onwards. 1.2.0 is the first version of ntpsec to fully support NTS
as specified in RFC 8915.
...
server nts.ntp.se:4443 nts         # Sweden: only for ntpsec <1.2.0
------------------------------------------------------------
