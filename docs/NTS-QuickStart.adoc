...
These are development machines, so there may be gaps in availability, and they may run unreleased versions of NTPsec:
...
A https://netfuture.ch/2021/12/transparent-trustworthy-time-with-ntp-and-nts/#server-list
[list of public NTS servers] is availabe, with more info on NTS.
