...
Substituting an appropriate unit number for X. For subtype Y and time offset Z.ZZZ refer to this table:

[width="60%",cols="<25%,<25%,<50%",options="header"]
|====================================
| subtype | time1 (ms) | Model
| 0 | - | Palisade
| 1 | - | Praecis
| 2 | 0.020 | Thunderbolt
