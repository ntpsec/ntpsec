...
* Shared key authentication now supports HMAC mode.
It's one of the options for NIST's authenticated service.
...
See RFC 8915  Network Time Security for the Network Time Protocol
