 ...
 *
 *  It has been AutoGen-ed  August 10, 2013 at 11:29:51 AM by AutoGen 5.18.1pre3
...
/*  2789 */ "version\0"
/*  2797 */ "NTPD\0"
/*  2802 */ "ntpd - NTP daemon program - Ver. 4.2.7p383\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntpd - NTP daemon program - Ver. 4.2.7p383\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ <server1> ... <serverN> ]\n"));
