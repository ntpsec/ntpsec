 ...
 *
 *  It has been AutoGen-ed  March  4, 2015 at 11:54:17 AM by AutoGen 5.18.5pre4
...
/*  2866 */ "version\0"
/*  2874 */ "NTPD\0"
/*  2879 */ "ntpd - NTP daemon program - Ver. 4.3.4\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpd - NTP daemon program - Ver. 4.3.4\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ <server1> ... <serverN> ]\n"));
