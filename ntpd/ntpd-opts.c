 ...
 *
 *  It has been AutoGen-ed  September 16, 2013 at 11:31:26 AM by AutoGen 5.18.1pre5
...
/*  2789 */ "version\0"
/*  2797 */ "NTPD\0"
/*  2802 */ "ntpd - NTP daemon program - Ver. 4.2.7p387\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntpd - NTP daemon program - Ver. 4.2.7p387\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ <server1> ... <serverN> ]\n"));
