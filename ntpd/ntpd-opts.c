 ...
 *
 *  It has been AutoGen-ed  July 16, 2014 at 09:27:55 AM by AutoGen 5.18.3pre18
...
/*  2814 */ "version\0"
/*  2822 */ "NTPD\0"
/*  2827 */ "ntpd - NTP daemon program - Ver. 4.2.7p449\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntpd - NTP daemon program - Ver. 4.2.7p449\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ <server1> ... <serverN> ]\n"));
