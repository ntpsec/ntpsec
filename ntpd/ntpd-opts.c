 ...
 *
 *  It has been AutoGen-ed  August  1, 2013 at 06:35:30 AM by AutoGen 5.18.1pre3
...
/*  2789 */ "version\0"
/*  2797 */ "NTPD\0"
/*  2802 */ "ntpd - NTP daemon program - Ver. 4.2.7p378\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntpd - NTP daemon program - Ver. 4.2.7p378\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ <server1> ... <serverN> ]\n"));
