 ...
 *
 *  It has been AutoGen-ed  February  8, 2014 at 11:18:47 AM by AutoGen 5.18.3pre11
...
/*  2814 */ "version\0"
/*  2822 */ "NTPD\0"
/*  2827 */ "ntpd - NTP daemon program - Ver. 4.2.7p419\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntpd - NTP daemon program - Ver. 4.2.7p419\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ <server1> ... <serverN> ]\n"));
