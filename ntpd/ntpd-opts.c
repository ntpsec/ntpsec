 ...
 *
 *  It has been AutoGen-ed  March  3, 2013 at 11:35:48 AM by AutoGen 5.17.3.pre2
...
/*  2789 */ "version\0"
/*  2797 */ "NTPD\0"
/*  2802 */ "ntpd - NTP daemon program - Ver. 4.2.7p359\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntpd - NTP daemon program - Ver. 4.2.7p359\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \\\n\
\t\t[ <server1> ... <serverN> ]\n"));
