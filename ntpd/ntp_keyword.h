 ...
 *	 Generated 2010-02-21 19:31:47 UTC	  diff_ignore_line
 *
 */
...
#define SCANNER_INIT_S 744

const scan_state sst[747] = {
/*SS_T( ch,	f-by, match, other ),				 */
  ...
  S_ST( 'r',	1,      628,     0 ), /*   377 T_Server          */
  S_ST( 'r',	1,        0,     0 ), /*   378 T_Setvar          */
  S_ST( 'n',	1,        0,     0 ), /*   379 T_Sign            */
  S_ST( 'e',	0,        0,     0 ), /*   380 T_Source          */
  S_ST( 's',	0,        0,     0 ), /*   381 T_Statistics      */
  S_ST( 's',	0,      667,   662 ), /*   382 T_Stats           */
  S_ST( 'r',	1,        0,     0 ), /*   383 T_Statsdir        */
  S_ST( 'p',	0,      670,     0 ), /*   384 T_Step            */
  ...
  S_ST( 'e',	3,      424,     0 ), /*   423                   */
  S_ST( 'n',	3,      328,     0 ), /*   424                   */
  S_ST( 's',	3,      426,   410 ), /*   425                   */
  S_ST( 'e',	3,      427,     0 ), /*   426                   */
  S_ST( 'r',	3,      428,     0 ), /*   427                   */
  S_ST( 'v',	3,      429,     0 ), /*   428                   */
  S_ST( 'e',	3,      329,     0 ), /*   429                   */
  S_ST( 's',	3,      330,   291 ), /*   430                   */
  S_ST( 'x',	3,      439,   430 ), /*   431                   */
  S_ST( 'c',	3,      433,     0 ), /*   432                   */
  S_ST( 'l',	3,      434,     0 ), /*   433                   */
  S_ST( 'o',	3,      435,     0 ), /*   434                   */
  S_ST( 'c',	3,      331,     0 ), /*   435                   */
  S_ST( 'd',	3,      437,   432 ), /*   436                   */
  S_ST( 'i',	3,      438,     0 ), /*   437                   */
  S_ST( 's',	3,      332,     0 ), /*   438                   */
  S_ST( 'p',	3,      440,   436 ), /*   439                   */
  S_ST( 'o',	3,      441,     0 ), /*   440                   */
  S_ST( 'l',	3,      333,     0 ), /*   441                   */
  S_ST( 'i',	3,      443,   286 ), /*   442                   */
  S_ST( 'n',	3,      457,     0 ), /*   443                   */
  S_ST( 'c',	3,      445,     0 ), /*   444                   */
  S_ST( 'l',	3,      446,     0 ), /*   445                   */
  S_ST( 'o',	3,      447,     0 ), /*   446                   */
  S_ST( 'c',	3,      334,     0 ), /*   447                   */
  S_ST( 'd',	3,      449,   444 ), /*   448                   */
  S_ST( 'i',	3,      450,     0 ), /*   449                   */
  S_ST( 's',	3,      335,     0 ), /*   450                   */
  S_ST( 'i',	3,      452,   448 ), /*   451                   */
  S_ST( 'm',	3,      453,     0 ), /*   452                   */
  S_ST( 'u',	3,      336,     0 ), /*   453                   */
  S_ST( 'p',	3,      455,   451 ), /*   454                   */
  S_ST( 'o',	3,      456,     0 ), /*   455                   */
  S_ST( 'l',	3,      337,     0 ), /*   456                   */
  S_ST( 's',	3,      458,   454 ), /*   457                   */
  S_ST( 'a',	3,      459,     0 ), /*   458                   */
  S_ST( 'n',	3,      338,     0 ), /*   459                   */
  S_ST( 'o',	3,      462,   442 ), /*   460                   */
  S_ST( 'd',	3,      339,     0 ), /*   461                   */
  S_ST( 'n',	3,      466,   461 ), /*   462                   */
  S_ST( 'i',	3,      464,     0 ), /*   463                   */
  S_ST( 't',	3,      465,     0 ), /*   464                   */
  S_ST( 'o',	3,      340,     0 ), /*   465                   */
  S_ST( 't',	3,      341,   463 ), /*   466                   */
  S_ST( 's',	3,      468,   460 ), /*   467                   */
  S_ST( 's',	3,      469,     0 ), /*   468                   */
  S_ST( 'n',	3,      470,     0 ), /*   469                   */
  S_ST( 't',	3,      319,     0 ), /*   470                   */
  S_ST( 'u',	3,      472,   467 ), /*   471                   */
  S_ST( 'l',	3,      473,     0 ), /*   472                   */
  S_ST( 't',	3,      474,     0 ), /*   473                   */
  S_ST( 'i',	3,      475,     0 ), /*   474                   */
  S_ST( 'c',	3,      476,     0 ), /*   475                   */
  ...
  S_ST( 'e',	3,      483,     0 ), /*   482                   */
  S_ST( 'n',	3,      342,     0 ), /*   483                   */
  S_ST( 'n',	3,      515,   257 ), /*   484                   */
  S_ST( 'i',	3,      343,     0 ), /*   485                   */
  S_ST( 'o',	3,      510,   485 ), /*   486                   */
  S_ST( 'l',	3,      488,     0 ), /*   487                   */
  S_ST( 'i',	3,      489,     0 ), /*   488                   */
  S_ST( 'n',	3,      344,     0 ), /*   489                   */
  S_ST( 'm',	3,      491,   487 ), /*   490                   */
  S_ST( 'o',	3,      492,     0 ), /*   491                   */
  S_ST( 'd',	3,      493,     0 ), /*   492                   */
  S_ST( 'i',	3,      494,     0 ), /*   493                   */
  S_ST( 'f',	3,      345,     0 ), /*   494                   */
  S_ST( 'n',	3,      346,   490 ), /*   495                   */
  S_ST( 'p',	3,      497,   495 ), /*   496                   */
  S_ST( 'e',	3,      498,     0 ), /*   497                   */
  S_ST( 'e',	3,      347,     0 ), /*   498                   */
  S_ST( 'q',	3,      500,   496 ), /*   499                   */
  S_ST( 'u',	3,      501,     0 ), /*   500                   */
  S_ST( 'e',	3,      502,     0 ), /*   501                   */
  S_ST( 'r',	3,      348,     0 ), /*   502                   */
  S_ST( 's',	3,      504,   499 ), /*   503                   */
  S_ST( 'e',	3,      508,     0 ), /*   504                   */
  S_ST( 'l',	3,      506,     0 ), /*   505                   */
  S_ST( 'e',	3,      507,     0 ), /*   506                   */
  S_ST( 'c',	3,      349,     0 ), /*   507                   */
  S_ST( 'r',	3,      509,   505 ), /*   508                   */
  S_ST( 'v',	3,      350,     0 ), /*   509                   */
  S_ST( 't',	3,      511,   503 ), /*   510                   */
  S_ST( 'r',	3,      513,     0 ), /*   511                   */
  S_ST( 'a',	3,      351,     0 ), /*   512                   */
  S_ST( 'u',	3,      514,   512 ), /*   513                   */
  S_ST( 's',	3,      352,     0 ), /*   514                   */
  S_ST( 't',	3,      353,   486 ), /*   515                   */
  S_ST( 'p',	3,      517,     0 ), /*   516                   */
  S_ST( 'o',	3,      518,     0 ), /*   517                   */
  S_ST( 'r',	3,      354,     0 ), /*   518                   */
  S_ST( 's',	3,      520,   516 ), /*   519                   */
  S_ST( 'i',	3,      521,     0 ), /*   520                   */
  S_ST( 'g',	3,      522,     0 ), /*   521                   */
  S_ST( 'n',	3,      523,     0 ), /*   522                   */
  S_ST( 'd',	3,      524,     0 ), /*   523                   */
  ...
  S_ST( 'k',	3,      528,     0 ), /*   527                   */
  S_ST( 'e',	3,      355,     0 ), /*   528                   */
  S_ST( 'o',	3,      530,   484 ), /*   529                   */
  S_ST( 'r',	3,      531,     0 ), /*   530                   */
  S_ST( 'p',	3,      532,     0 ), /*   531                   */
  S_ST( 'h',	3,      533,     0 ), /*   532                   */
  S_ST( 'a',	3,      356,     0 ), /*   533                   */
  S_ST( 'p',	3,      368,   529 ), /*   534                   */
  S_ST( 'a',	3,      536,     0 ), /*   535                   */
  S_ST( 'n',	3,      537,     0 ), /*   536                   */
  S_ST( 'i',	3,      357,     0 ), /*   537                   */
  S_ST( 'e',	3,      539,   535 ), /*   538                   */
  S_ST( 'e',	3,      358,     0 ), /*   539                   */
  S_ST( 's',	3,      541,     0 ), /*   540                   */
  S_ST( 't',	3,      542,     0 ), /*   541                   */
  S_ST( 'a',	3,      543,     0 ), /*   542                   */
  S_ST( 't',	3,      359,     0 ), /*   543                   */
  S_ST( 'h',	3,      545,   538 ), /*   544                   */
  S_ST( 'o',	3,      546,     0 ), /*   545                   */
  S_ST( 'n',	3,      360,     0 ), /*   546                   */
  S_ST( 'i',	3,      361,   544 ), /*   547                   */
  S_ST( 'f',	3,      549,     0 ), /*   548                   */
  S_ST( 'i',	3,      550,     0 ), /*   549                   */
  S_ST( 'l',	3,      362,     0 ), /*   550                   */
  S_ST( 'o',	3,      553,   547 ), /*   551                   */
  S_ST( 'o',	3,      363,     0 ), /*   552                   */
  S_ST( 'r',	3,      364,   552 ), /*   553                   */
  S_ST( 'r',	3,      561,   551 ), /*   554                   */
  S_ST( 'e',	3,      559,     0 ), /*   555                   */
  S_ST( 'e',	3,      557,     0 ), /*   556                   */
  S_ST( 'm',	3,      558,     0 ), /*   557                   */
  S_ST( 'p',	3,      365,     0 ), /*   558                   */
  S_ST( 'f',	3,      560,   556 ), /*   559                   */
  S_ST( 'e',	3,      366,     0 ), /*   560                   */
  S_ST( 'o',	3,      574,   555 ), /*   561                   */
  S_ST( 'c',	3,      563,     0 ), /*   562                   */
  S_ST( '_',	3,      564,     0 ), /*   563                   */
  S_ST( 'd',	3,      565,     0 ), /*   564                   */
  S_ST( 'e',	3,      566,     0 ), /*   565                   */
  S_ST( 'l',	3,      567,     0 ), /*   566                   */
  S_ST( 'a',	3,      420,     0 ), /*   567                   */
  S_ST( 'p',	3,      569,   562 ), /*   568                   */
  S_ST( '_',	3,      570,     0 ), /*   569                   */
  S_ST( 'd',	3,      571,     0 ), /*   570                   */
  S_ST( 'e',	3,      572,     0 ), /*   571                   */
  S_ST( 'l',	3,      573,     0 ), /*   572                   */
  S_ST( 'a',	3,      419,     0 ), /*   573                   */
  S_ST( 't',	3,      575,   568 ), /*   574                   */
  S_ST( 'o',	3,      576,     0 ), /*   575                   */
  S_ST( 's',	3,      577,     0 ), /*   576                   */
  S_ST( 't',	3,      578,     0 ), /*   577                   */
  S_ST( 'a',	3,      579,     0 ), /*   578                   */
  S_ST( 't',	3,      367,     0 ), /*   579                   */
  S_ST( 'q',	3,      581,   534 ), /*   580                   */
  S_ST( 'o',	3,      369,     0 ), /*   581                   */
  S_ST( 'r',	3,      594,   580 ), /*   582                   */
  S_ST( 'a',	3,      589,     0 ), /*   583                   */
  S_ST( 'n',	3,      585,     0 ), /*   584                   */
  S_ST( 'd',	3,      586,     0 ), /*   585                   */
  S_ST( 'f',	3,      587,     0 ), /*   586                   */
  S_ST( 'i',	3,      588,     0 ), /*   587                   */
  S_ST( 'l',	3,      370,     0 ), /*   588                   */
  S_ST( 'w',	3,      590,   584 ), /*   589                   */
  S_ST( 's',	3,      591,     0 ), /*   590                   */
  S_ST( 't',	3,      592,     0 ), /*   591                   */
  S_ST( 'a',	3,      593,     0 ), /*   592                   */
  S_ST( 't',	3,      371,     0 ), /*   593                   */
  S_ST( 'e',	3,      609,   583 ), /*   594                   */
  S_ST( 'f',	3,      596,     0 ), /*   595                   */
  S_ST( 'i',	3,      372,     0 ), /*   596                   */
  S_ST( 'q',	3,      598,   595 ), /*   597                   */
  S_ST( 'u',	3,      599,     0 ), /*   598                   */
  S_ST( 'e',	3,      600,     0 ), /*   599                   */
  S_ST( 's',	3,      601,     0 ), /*   600                   */
  S_ST( 't',	3,      602,     0 ), /*   601                   */
  S_ST( 'k',	3,      603,     0 ), /*   602                   */
  S_ST( 'e',	3,      373,     0 ), /*   603                   */
  S_ST( 's',	3,      605,   597 ), /*   604                   */
  S_ST( 't',	3,      606,     0 ), /*   605                   */
  S_ST( 'r',	3,      607,     0 ), /*   606                   */
  S_ST( 'i',	3,      608,     0 ), /*   607                   */
  S_ST( 'c',	3,      374,     0 ), /*   608                   */
  S_ST( 'v',	3,      610,   604 ), /*   609                   */
  S_ST( 'o',	3,      611,     0 ), /*   610                   */
  S_ST( 'k',	3,      375,     0 ), /*   611                   */
  S_ST( 's',	3,      676,   582 ), /*   612                   */
  S_ST( 'a',	3,      614,     0 ), /*   613                   */
  S_ST( 'v',	3,      615,     0 ), /*   614                   */
  S_ST( 'e',	3,      616,     0 ), /*   615                   */
  S_ST( 'c',	3,      617,     0 ), /*   616                   */
  ...
  S_ST( 's',	3,      633,     0 ), /*   632                   */
  S_ST( 'e',	3,      414,     0 ), /*   633                   */
  S_ST( 't',	3,      635,   625 ), /*   634                   */
  S_ST( 'v',	3,      636,     0 ), /*   635                   */
  S_ST( 'a',	3,      378,     0 ), /*   636                   */
  S_ST( 'i',	3,      639,   624 ), /*   637                   */
  S_ST( 'g',	3,      379,     0 ), /*   638                   */
  S_ST( 'm',	3,      640,   638 ), /*   639                   */
  S_ST( 'u',	3,      641,     0 ), /*   640                   */
  S_ST( 'l',	3,      642,     0 ), /*   641                   */
  S_ST( 'a',	3,      643,     0 ), /*   642                   */
  S_ST( 't',	3,      644,     0 ), /*   643                   */
  S_ST( 'i',	3,      645,   411 ), /*   644                   */
  S_ST( 'o',	3,      646,     0 ), /*   645                   */
  S_ST( 'n',	3,      647,     0 ), /*   646                   */
  S_ST( '_',	3,      648,     0 ), /*   647                   */
  S_ST( 'd',	3,      649,     0 ), /*   648                   */
  ...
  S_ST( 'i',	3,      654,     0 ), /*   653                   */
  S_ST( 'o',	3,      413,     0 ), /*   654                   */
  S_ST( 'o',	3,      656,   637 ), /*   655                   */
  S_ST( 'u',	3,      657,     0 ), /*   656                   */
  S_ST( 'r',	3,      658,     0 ), /*   657                   */
  S_ST( 'c',	3,      380,     0 ), /*   658                   */
  S_ST( 't',	3,      672,   655 ), /*   659                   */
  S_ST( 'a',	3,      661,     0 ), /*   660                   */
  S_ST( 't',	3,      382,     0 ), /*   661                   */
  S_ST( 'i',	3,      663,     0 ), /*   662                   */
  S_ST( 's',	3,      664,     0 ), /*   663                   */
  ...
  S_ST( 'd',	3,      668,     0 ), /*   667                   */
  S_ST( 'i',	3,      383,     0 ), /*   668                   */
  S_ST( 'e',	3,      384,   660 ), /*   669                   */
  S_ST( 'o',	3,      671,     0 ), /*   670                   */
  S_ST( 'u',	3,      385,     0 ), /*   671                   */
  S_ST( 'r',	3,      673,   669 ), /*   672                   */
  S_ST( 'a',	3,      674,     0 ), /*   673                   */
  S_ST( 't',	3,      675,     0 ), /*   674                   */
  S_ST( 'u',	3,      386,     0 ), /*   675                   */
  S_ST( 'y',	3,      677,   659 ), /*   676                   */
  S_ST( 's',	3,      678,     0 ), /*   677                   */
  S_ST( 's',	3,      679,     0 ), /*   678                   */
  S_ST( 't',	3,      680,     0 ), /*   679                   */
  S_ST( 'a',	3,      681,     0 ), /*   680                   */
  S_ST( 't',	3,      388,     0 ), /*   681                   */
  S_ST( 't',	3,      708,   612 ), /*   682                   */
  S_ST( 'i',	3,      694,     0 ), /*   683                   */
  S_ST( 'c',	3,      389,     0 ), /*   684                   */
  S_ST( 'm',	3,      687,   684 ), /*   685                   */
  S_ST( 'e',	3,      391,     0 ), /*   686                   */
  S_ST( 'i',	3,      688,   686 ), /*   687                   */
  S_ST( 'n',	3,      689,     0 ), /*   688                   */
  S_ST( 'g',	3,      690,     0 ), /*   689                   */
  S_ST( 's',	3,      691,     0 ), /*   690                   */
  S_ST( 't',	3,      692,     0 ), /*   691                   */
  S_ST( 'a',	3,      693,     0 ), /*   692                   */
  S_ST( 't',	3,      392,     0 ), /*   693                   */
  S_ST( 'n',	3,      695,   685 ), /*   694                   */
  S_ST( 'k',	3,      696,     0 ), /*   695                   */
  S_ST( 'e',	3,      393,     0 ), /*   696                   */
  S_ST( 'o',	3,      394,   683 ), /*   697                   */
  S_ST( 'r',	3,      700,   697 ), /*   698                   */
  S_ST( 'a',	3,      395,     0 ), /*   699                   */
  S_ST( 'u',	3,      701,   699 ), /*   700                   */
  S_ST( 's',	3,      702,   396 ), /*   701                   */
  S_ST( 't',	3,      703,     0 ), /*   702                   */
  S_ST( 'e',	3,      704,     0 ), /*   703                   */
  S_ST( 'd',	3,      705,     0 ), /*   704                   */
  S_ST( 'k',	3,      706,     0 ), /*   705                   */
  S_ST( 'e',	3,      397,     0 ), /*   706                   */
  S_ST( 't',	3,      398,   698 ), /*   707                   */
  S_ST( 'y',	3,      709,   707 ), /*   708                   */
  S_ST( 'p',	3,      399,     0 ), /*   709                   */
  S_ST( 'u',	3,      711,   682 ), /*   710                   */
  S_ST( 'n',	3,      717,     0 ), /*   711                   */
  S_ST( 'c',	3,      713,     0 ), /*   712                   */
  S_ST( 'o',	3,      714,     0 ), /*   713                   */
  S_ST( 'n',	3,      715,     0 ), /*   714                   */
  S_ST( 'f',	3,      716,     0 ), /*   715                   */
  S_ST( 'i',	3,      400,     0 ), /*   716                   */
  S_ST( 'p',	3,      718,   712 ), /*   717                   */
  S_ST( 'e',	3,      719,     0 ), /*   718                   */
  S_ST( 'e',	3,      401,     0 ), /*   719                   */
  S_ST( 'v',	3,      721,   710 ), /*   720                   */
  S_ST( 'e',	3,      722,     0 ), /*   721                   */
  S_ST( 'r',	3,      723,     0 ), /*   722                   */
  S_ST( 's',	3,      724,     0 ), /*   723                   */
  S_ST( 'i',	3,      725,     0 ), /*   724                   */
  S_ST( 'o',	3,      402,     0 ), /*   725                   */
  S_ST( 'w',	3,      733,   720 ), /*   726                   */
  S_ST( 'a',	3,      728,     0 ), /*   727                   */
  S_ST( 'n',	3,      729,     0 ), /*   728                   */
  S_ST( 'd',	3,      730,     0 ), /*   729                   */
  S_ST( 'e',	3,      417,     0 ), /*   730                   */
  S_ST( 'e',	3,      732,   727 ), /*   731                   */
  S_ST( 'e',	3,      404,     0 ), /*   732                   */
  S_ST( 'i',	3,      734,   731 ), /*   733                   */
  S_ST( 'l',	3,      735,     0 ), /*   734                   */
  S_ST( 'd',	3,      736,     0 ), /*   735                   */
  S_ST( 'c',	3,      737,     0 ), /*   736                   */
  S_ST( 'a',	3,      738,     0 ), /*   737                   */
  S_ST( 'r',	3,      405,     0 ), /*   738                   */
  S_ST( 'x',	3,      740,   726 ), /*   739                   */
  S_ST( 'l',	3,      741,     0 ), /*   740                   */
  S_ST( 'e',	3,      742,     0 ), /*   741                   */
  S_ST( 'a',	3,      743,     0 ), /*   742                   */
  S_ST( 'v',	3,      406,     0 ), /*   743                   */
  S_ST( 'y',	3,      745,   739 ), /*   744 initial state     */
  S_ST( 'e',	3,      746,     0 ), /*   745                   */
  S_ST( 'a',	3,      407,     0 )  /*   746                   */
};
