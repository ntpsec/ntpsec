 ...
 *
 *  It has been AutoGen-ed  February 21, 2013 at 09:26:54 PM by AutoGen 5.17.2pre17
...
/*  1373 */ "no\0"
/*  1376 */ "NTPSNMPD\0"
/*  1385 */ "ntpsnmpd - NTP SNMP MIB agent - Ver. 4.2.7p356\n"
...
static void bogus_function(void) {
  /* TRANSLATORS:
     ...
     in the ntpsnmpdOptions structure noted in the comments below.  The
     literal text is defined in ntpsnmpd_opt_strs.
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntpsnmpd - NTP SNMP MIB agent - Ver. 4.2.7p356\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
