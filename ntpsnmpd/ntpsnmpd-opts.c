 ...
 *
 *  It has been AutoGen-ed  February 25, 2015 at 11:57:58 AM by AutoGen 5.18.5pre4
...
/*  1425 */ "no\0"
/*  1428 */ "NTPSNMPD\0"
/*  1437 */ "ntpsnmpd - NTP SNMP MIB agent - Ver. 4.3.2\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpsnmpd - NTP SNMP MIB agent - Ver. 4.3.2\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
