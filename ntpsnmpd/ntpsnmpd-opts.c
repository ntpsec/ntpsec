 ...
 *
 *  It has been AutoGen-ed  March  3, 2013 at 11:38:10 AM by AutoGen 5.17.3.pre2
...
/*  1373 */ "no\0"
/*  1376 */ "NTPSNMPD\0"
/*  1385 */ "ntpsnmpd - NTP SNMP MIB agent - Ver. 4.2.7p359\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntpsnmpd - NTP SNMP MIB agent - Ver. 4.2.7p359\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
