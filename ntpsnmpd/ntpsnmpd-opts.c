 ...
 *
 *  It has been AutoGen-ed  July 16, 2014 at 09:31:53 AM by AutoGen 5.18.3pre18
...
/*  1373 */ "no\0"
/*  1376 */ "NTPSNMPD\0"
/*  1385 */ "ntpsnmpd - NTP SNMP MIB agent - Ver. 4.2.7p449\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntpsnmpd - NTP SNMP MIB agent - Ver. 4.2.7p449\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
