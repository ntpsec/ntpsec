 ...
 *
 *  It has been AutoGen-ed  February 28, 2015 at 12:58:24 PM by AutoGen 5.18.5pre4
...
/*  1425 */ "no\0"
/*  1428 */ "NTPSNMPD\0"
/*  1437 */ "ntpsnmpd - NTP SNMP MIB agent - Ver. 4.3.3\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpsnmpd - NTP SNMP MIB agent - Ver. 4.3.3\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]...\n"));
