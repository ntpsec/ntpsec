 ...
 *
 *  It has been AutoGen-ed  February 28, 2015 at 12:57:49 PM by AutoGen 5.18.5pre4
...
/*  1734 */ "no\0"
/*  1737 */ "NTPQ\0"
/*  1742 */ "ntpq - standard NTP query program - Ver. 4.3.3\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpq - standard NTP query program - Ver. 4.3.3\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
