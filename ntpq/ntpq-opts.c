 ...
 *
 *  It has been AutoGen-ed  April  1, 2014 at 10:44:57 AM by AutoGen 5.18.3pre18
...
/*  1640 */ "no\0"
/*  1643 */ "NTPQ\0"
/*  1648 */ "ntpq - standard NTP query program - Ver. 4.2.7p438\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntpq - standard NTP query program - Ver. 4.2.7p438\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
