 ...
 *
 *  It has been AutoGen-ed  March 29, 2015 at 07:12:16 AM by AutoGen 5.18.5pre4
...
/*  1735 */ "no\0"
/*  1738 */ "NTPQ\0"
/*  1743 */ "ntpq - standard NTP query program - Ver. 4.3.11\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpq - standard NTP query program - Ver. 4.3.11\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
