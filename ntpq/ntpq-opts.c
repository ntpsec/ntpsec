 ...
 *
 *  It has been AutoGen-ed  August 28, 2014 at 08:56:24 AM by AutoGen 5.18.4pre24
...
/*  1682 */ "no\0"
/*  1685 */ "NTPQ\0"
/*  1690 */ "ntpq - standard NTP query program - Ver. 4.2.7p467\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntpq - standard NTP query program - Ver. 4.2.7p467\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
