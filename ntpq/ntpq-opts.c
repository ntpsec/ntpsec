 ...
 *
 *  It has been AutoGen-ed  August  8, 2013 at 11:36:28 AM by AutoGen 5.18.1pre3
...
/*  1640 */ "no\0"
/*  1643 */ "NTPQ\0"
/*  1648 */ "ntpq - standard NTP query program - Ver. 4.2.7p382\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntpq - standard NTP query program - Ver. 4.2.7p382\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
