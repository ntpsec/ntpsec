 ...
 *
 *  It has been AutoGen-ed  March  6, 2015 at 11:57:25 AM by AutoGen 5.18.5pre4
...
/*  1734 */ "no\0"
/*  1737 */ "NTPQ\0"
/*  1742 */ "ntpq - standard NTP query program - Ver. 4.3.6\n"
...
implied warranty.\n"));
  ...
  puts(_("ntpq - standard NTP query program - Ver. 4.3.6\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
