 ...
 *
 *  It has been AutoGen-ed  February  5, 2014 at 12:00:30 PM by AutoGen 5.18.3pre11
...
/*  1640 */ "no\0"
/*  1643 */ "NTPQ\0"
/*  1648 */ "ntpq - standard NTP query program - Ver. 4.2.7p418\n"
...
provided \"as is\" without express or implied warranty.\n"));
  ...
  puts(_("ntpq - standard NTP query program - Ver. 4.2.7p418\n\
Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [ host ...]\n"));
